...
export const spec = suite(`@robertakarobin/web`,
	...
	test(`component`, $ => {
		...
		$.assert(x => x(widget(`x`)) === `<script src="data:text/javascript," onload="window.Component=window.Component||{};window.Component['/UID/']=[this,'Widget',{0:'x',uid:'/UID/',}]"></script><h1>x42</h1>`);
	}),
);
